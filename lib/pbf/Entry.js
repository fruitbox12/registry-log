...
exports.Entry = {
    decode(buf) {
        ...
        return pbf.readFields((tag, obj, pbf) => {
            if (obj) {
                ...
                else if (tag === 7 && 'undefined' !== typeof obj.target && pbf) {
                    obj.target = pbf.readString();
                }
                else if (tag === 8 && 'undefined' !== typeof obj.title && pbf) {
                    obj.title = pbf.readString();
                }
                else if (tag === 9 && 'undefined' !== typeof obj.description && pbf) {
                    obj.description = pbf.readString();
                }
            }
    ...
    encode(obj) {
        ...
        if (obj.target) {
            pbf.writeStringField(7, obj.target);
        }
        if (obj.title) {
            pbf.writeStringField(8, obj.title);
        }
        if (obj.description) {
            pbf.writeStringField(9, obj.description);
        }
